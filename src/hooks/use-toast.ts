...
export const reducer = (state: State, action: Action): State => {
  assertInvariant(state != null, "Expected state")
  assertInvariant(action != null && typeof action.type === "string", "Expected action")
  switch (action.type) {
    case 'ADD_TOAST':
      return {
        ...state,
...
function dispatch(action: Action) {
  assertInvariant(action != null, "Expected action")
